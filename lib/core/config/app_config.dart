class AppConfig {
  ...
  // Default to Firebase when the platform has a native configuration.
  // Pass `--dart-define=USE_FIREBASE=false` to force demo mode.
  static const bool requestedFirebase =
      bool.fromEnvironment('USE_FIREBASE', defaultValue: true);
  static const bool requestedMongoBackend =
      bool.fromEnvironment('USE_MONGO_BACKEND', defaultValue: false);
  static const String mongoBackendBaseUrl =
      String.fromEnvironment('MONGO_BACKEND_BASE_URL');
